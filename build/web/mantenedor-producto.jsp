                ...
                <form class="col s12" action="<c:url value="/ProductoServlet"/>" method="post">
                    <div class="row">
                        <div class="input-field col s6">
                            <input placeholder="Ingrese código del producto" id="id_prod" type="text" class="validate" name="codigo_producto" value="">
                        ...
                        <div class="input-field col s12">
                            <input placeholder="Ingrese nombre del producto" id="nombre_prod" type="text" class="validate" name="nombre">
                        ...
                        <div class="input-field col s12">
                            ...
                            <div class="input-field col s12">
                                <input  placeholder="Ingrese Precio" id="precio" type="text" class="validate" name="precio">
