                ...
                <form class="col s12" action="<c:url value="ClienteServlet"/>" method="post">
                    <div class="row">
                        <div class="input-field col s6">
                            <input   placeholder=" "  id="rut" type="text" class="validate" name="rut" value="${rut}" >
                        ...
                        <div class="input-field col s12">
                            <input placeholder=" " name="nombre" id="nombre" type="text" class="validate" value="${nombre}">
                            <label for="nombre">Nombre</label>
                        </div>
                        <div class="input-field col s12">
                            <input  id="apellido" type="text" class="validate" name="apellido" value="${apellido}">
                            <label for="apellido">Apellido</label>
                        </div>
                    </div>
                    <div class="input-field col s12">
                        <input  id="clave" type="text" class="validate" name="pw" value="${contraseña}">
