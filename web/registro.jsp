<%-- 
    Document   : ingresar
    Created on : 07-jun-2018, 20:46:24
    Author     : zoekt
--%>
        ...
        <nav class="light-blue lighten-1" role="navigation">
            <div class="nav-wrapper container"><a id="logo-container" href="index.jsp" class="brand-logo"><img src="img/comprayventa-logoblanco.png"/></a>
                <ul class="right hide-on-med-and-down">
                    <li>Bienvenido/a [acá va el texto]</li>
            ...
            <div class="section">
                ...
                <form class="col s12" action="<c:url value="ClienteServlet"/>" method="post">
                    <div class="row">
                        ...
                        <div class="input-field col s6">
                            <input  placeholder="Ingrese su Apellido" id="apellido" type="text" class="validate" name="apellido">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s6">
                            <input  placeholder="Ingrese su Contraseña" id="clave" type="text" class="validate" name="pw">
                            <label for="clave">Contraseña</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col s12 center" style="margin-top: 50px;">
                            <button class="btn light-blue" type="submit" name="btn" value="Registrar">Registrar</button>
                        </div>
                    </div>
